...
const modal = ({
  ...
  const modalOpts = {
    title: `${type === 'create' ? '新建个人同意征信书' : '修改个人同意征信书'}`,
    visible,
    onOk: handleOk,
    onCancel,
  ...
  const props = {
    action: '/InputSystem/DataService/api/v1/upload/grtyzhengxin/'+item.KeyID,
    listType: 'picture',
  ...
  return (
    <Modal {...modalOpts}>
      <Form horizontal>
        ...
        <FormItem label='征信编号：' hasFeedback {...formItemLayout}>
