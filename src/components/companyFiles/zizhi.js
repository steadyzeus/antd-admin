...
class zizhi extends React.Component {
  constructor (props) {
    super(props)
    this.enterAnim = [
      {
  ...
  render () {
    ...
    return <div className={styles.marginBottom}>
      <span className={styles.title}>企业资质信息表</span><Button className={styles.marginLeft15} type="primary" icon="plus" onClick={onAdd}>添加企业资质信息表</Button>
