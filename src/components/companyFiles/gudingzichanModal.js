...
const modal = ({
  ...
  const modalOpts = {
    title: `${type === 'create' ? '新建固定资产信息' : '修改固定资产信息'}`,
    visible,
    onOk: handleOk,
    onCancel,
  ...
  return (
    <Modal {...modalOpts}>
      <Form horizontal>
        <FormItem label='固定资产名称：' hasFeedback {...formItemLayout}>
          {getFieldDecorator('FixAssetsName', {
            initialValue: item.FixAssetsName,
            rules: [
              {
                required: true,
                message: '固定资产名称'
        ...
        <FormItem label='原始价值：' hasFeedback {...formItemLayout}>
          {getFieldDecorator('OriValue', {
            initialValue: item.OriValue,
            rules: [
              {
                required: false,
                message: '请填写原始价值'
        ...
        <FormItem label='累计折旧' hasFeedback {...formItemLayout}>
          {getFieldDecorator('DownValue', {
            initialValue: item.DownValue,
            rules: [
              {
                required: false,
                message: '请填写累计折旧'
        ...
        <FormItem label='现有价值：' hasFeedback {...formItemLayout}>
